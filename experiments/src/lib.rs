...
const PALETTE_RETRO: Palette = Palette {
    ...
    dim: Color::Rgb(0x3A, 0x2A, 0x00),
    primary: Color::Rgb(0xFF, 0xB0, 0x00),
    bright: Color::Rgb(0xFF, 0xD9, 0x66),
    accent: Color::Rgb(0xFF, 0x6A, 0x00),
    accent2: Color::Rgb(0xFF, 0x6A, 0x00),
    warn: Color::Rgb(0xFF, 0x6A, 0x00),
};
...
const PALETTE_MINIMAL: Palette = Palette {
    ...
    dim: Color::Rgb(0x6B, 0x6B, 0x73),
    primary: Color::Rgb(0xE8, 0xE8, 0xEC),
    bright: Color::Rgb(0xFF, 0xFF, 0xFF),
    accent: Color::Rgb(0x7C, 0x5C, 0xFF),
    accent2: Color::Rgb(0x7C, 0x5C, 0xFF),
...
const PALETTE_CYBER: Palette = Palette {
    ...
    dim: Color::Rgb(0x5A, 0x4A, 0x7A),
    primary: Color::Rgb(0xE8, 0xE8, 0xFF),
    bright: Color::Rgb(0xFF, 0x2E, 0x88),
    accent: Color::Rgb(0x00, 0xF0, 0xFF),
    accent2: Color::Rgb(0xFF, 0x2E, 0x88),
    warn: Color::Rgb(0xFF, 0x00, 0x33),
};
